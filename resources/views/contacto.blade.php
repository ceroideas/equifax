...
#social-sidebar[data-v-7b4478c1] {
    ...
    <style>
        img.graficologonegativo[data-v-5fddf304] {
            margin: 0 39px 0 0;
  ...
  position: relative;*/
    ...
    <style>
        div.portada-3dblue[data-v-66372912] {
            /* height: 870px;
  ...
  backdrop-filter: blur(2px);*/
    ...
    <style>
        .blockEstadisticas[data-v-e047c7bc] {
            -o-object-fit: contain;
            object-fit: contain;
 ...
 */
  ...
  .row{
    ...
    <style>
        .block-CheckClaim[data-v-837e15c2] {
            padding-top: 40px;
            background-color: #fff;
        }
    ...
    <style>
        .video-container[data-v-5d313d1e] {
            border-radius: 4px;
            margin: 0 auto;
            position: relative;
            display: flex;
    ...
    <style>
        .block-SlidesAbout[data-v-861c26ae] {
            background-color: #f8fafc;
  ...
  .swiper-slide:nth-child(3n) {
    ...
    <style>
        .Block-FormContact[data-v-ab748da8] {
            border-radius: 16px;
            box-shadow: 0 2px 4px 0 rgba(96, 97, 112, 0.1), 0 -1px 1px 0 rgba(40, 41, 61, 0.04);
            background-color: #fff;
            padding: 1.5rem;
    ...
    <style>
        .block-ResetPwd[data-v-41baacce] {
            background-color: #f8fafc;
            padding: 8px 0px;
        }
    ...
    <style>
        .modal-vue .fade-enter[data-v-994d5cde],
  ...
  .form-control {
    ...
    <style>
        .modal-vue .fade-enter[data-v-532fcf25],
    ...
    <style>
        .BlockCard.card[data-v-02ce8cf3] {
            border-radius: 16px;
            background-color: #fff;
            padding: 10px 30px;
        }
    ...
    <style>
        .BlockResumen .resumen-title[data-v-07c800bf] {
            font-family: Roobert;
            font-size: 18px;
            font-weight: normal;
            font-stretch: normal;
    ...
    <style>
        .Representacion[data-v-9bfde6aa] {
            border-radius: 16px;
            background-color: #fff;
            padding: 10px 20px 10px 20px;
        }
    ...
    <style>
        .ModalReclamacion[data-v-0cb2147a] {
            margin-bottom: 80px;
        }
    ...
    <style>
        .error-container[data-v-167ae8c1] {
            text-align: center;
            font-size: 180px;
    ...
    <div id="app">
        <main>
            <div data-v-effc9f78="" data-v-cfd2b624="">
                <div data-v-cfd2b624="" data-v-effc9f78="" class="block-Contacto">

{{--
                    <nav data-v-5fddf304="" data-v-cfd2b624="" class="navbar navbar-expand-lg navbar-dark"
                        data-v-effc9f78="">
                        <div data-v-5fddf304="" class="container"><a data-v-5fddf304="" href="{{ url('/') }}/"
                                class="navbar-brand router-link-active" style="">
                            ...
                            <div data-v-5fddf304="" id="navbarCollapse" class="navbar-collapse" style="display: none;">
                                <ul data-v-5fddf304="" class="navbar-nav">
                                    ...
                                    <li data-v-5fddf304="" class="nav-item"><a data-v-5fddf304=""
                                            href="{{ url('/') }}/tarifas" class="nav-link"><span
                                                data-v-5fddf304="" class="Type-something">
                                                Tarifas
                                            </span></a>
                                        <div data-v-5fddf304="" class=""></div>
                    ...
                    <div data-v-cfd2b624="" data-v-effc9f78="" class="Contacto container">
                        <div data-v-cfd2b624="" data-v-effc9f78="" class="row">
                            <div data-v-cfd2b624="" data-v-effc9f78=""
                                class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-xs-12 block-text">
                                <div data-v-cfd2b624="" data-v-effc9f78="" class="Contacto-subtitle">
                                    ¿Podemos ayudarte?
                                </div>
                                <div data-v-cfd2b624="" data-v-effc9f78="" class="Contacto-title mb-5">
                                    Contacto
                                </div>
                            ...
                            <div data-v-cfd2b624="" data-v-effc9f78=""
                                ...
                                <div data-v-ab748da8="" data-v-cfd2b624="" class="Block-FormContact"
                                    data-v-effc9f78="">
                                    <form data-v-ab748da8="" class="FormContact">
                                        <!---->
                                        <div data-v-ab748da8="" class="form-row">
                                            <div data-v-ab748da8="" class="form-group col-md-6 "><label
                                                    data-v-ab748da8="" for="nombre">Nombre</label> <input required
                                                    data-v-ab748da8="" type="text" id="nombre"
                                                    placeholder="Escribe tu nombre" class="form-control"> <span
                                                    data-v-ab748da8="" class="invalid-feedback">El campo Nombre es
                                                    requerido</span>
                                                <!---->
                                            </div>
                                            <div data-v-ab748da8="" class="form-group col-md-6 "><label
                                                    data-v-ab748da8="" for="apellidos">Apellidos</label> <input
                                                    required data-v-ab748da8="" type="text" id="apellidos"
                                                    placeholder="Escribe tus apellidos" class="form-control"> <span
                                                    data-v-ab748da8="" class="invalid-feedback">El campo Apellidos es
                                                    requerido</span>
                                                <!---->
                                            </div>
                                        </div>
                                        <div data-v-ab748da8="" class="form-group "><label data-v-ab748da8=""
                                                for="inputAddress">Email</label> <input required data-v-ab748da8=""
                                                type="email" id="inputAddress" placeholder="Escribe tu e-mail"
                                                class="form-control"> <span data-v-ab748da8=""
                                                class="invalid-feedback">El campo Email es requerido</span>
                                            <!---->
                                        </div>
                                        <div data-v-ab748da8="" class="form-group "><label data-v-ab748da8=""
