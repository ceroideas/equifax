    ...
    <div class=Section1>
        ...
        <p class="texto">Para poder participar y acceder a los servicios ofrecidos por DIVIDAE RECOVERY S.L., es necesario registrarse y abrir una cuenta en el sitio web:
            ...
            <ol class="texto" start=1 type=1>
                ...
                <li>Aceptar los Términos y Condiciones, y, por tanto, el acuerdo entre las partes cliqueando en el botón que se encuentra al lado de los Términos y Condiciones.</li>
                ...
                <li>Proporcionar una dirección, número de teléfono y dirección de email, para cualquier comunicación referente a su cuenta o pago. Se requerirá información adicional si es
                necesario para verificar su identidad.</li>
                <li>Acepta que la información y documentación aportada es veraz y correcta.</li>
                <li>Acepta que puede dictarse una sentencia desestimatoria de sus intereses.</li>
                <li>Acepta una posible condena en costas por la desestimación de la demanda o por alguna actuación llevada a cabo por él.</li>
                <li>Aceptar de buena fe, sin intención de defraudar, engañar o ir en contra de la legislación vigente.</li>
            </ol>
        </p>
        ...
        <p class="texto">Una vez registrado en la página web se le enviará automáticamente un email a la cuenta de correo facilitado en el formulario de registro con el fin de
            ...
            formalidades legales en la tramitación de los servicios contratados por el Usuario y a realizar los mejores esfuerzos para intentar lograr el éxito en la
            reclamación de las deudas del Usuario. Por último, <span class="dividae">Dividae</span> se compromete a prestar los servicios jurídicos contratados por el Usuario
            de forma correcta y adecuada según los estándares profesionales de naturaleza jurídica aplicables en España, efectuando en tiempo y forma todas las actuaciones
            necesarias en derecho e informando al Usuario sobre la conveniencia y naturaleza de dichos servicios, y poniendo a su disposición las notificaciones que se reciban
            del Juzgado o de los demás organismos competentes.
        </p>
        ...
        <p class="texto">Será necesario disponer de un correo electrónico y de un número de teléfono móvil, mediante los que se procederá a validar la autenticidad del Usuario
            ...
            incorporar datos del representante legal y adjuntar el poder de representación o título que lo acredite, domicilio o dirección fiscal, población, código postal y
        ...
        <p class="subtitulo">7. OBLIGACIONES DEL USUARIO</p>
        <p class="texto">Los usuarios que utilizan el portal de <a class="dividae" href="{{url('/')}}">www.dividae.com</a> para reclamar sus deudas expresamente aceptan que:
            1º) El Usuario será el/la único/a responsable del contenido de la información y documentos que introduzca en el sistema <a class="dividae" href="{{url('/')}}">www.dividae.com</a>,
            y se compromete a cumplir con todas las obligaciones derivadas de la legislación vigente. 2º) En particular, el Usuario se compromete a que la información y el contenido
            de los documentos que introduzca en el sistema en ningún caso:
        </p>
            <ul class="texto">
                ...
                <li>Contengan información falsa o inexacta, sean discriminatorios, ilegales, maliciosos, obscenos, fraudulentos, difamatorios, ofensivos, amenazantes y/o
                    pornográficos.</li>
                <li>Revelen o proporcionen información protegida por cualquier ley o Acuerdo.</li>
                <li>Contengan virus, “troyanos”, “gusanos”, o cualquier otro componente introducido con el fin de causar daños, interferir con el servicio o interceptar datos
                    del sistema o personales.</li>
        ...
        <p class="texto">
            ...
            acciones legales que estime oportunas para el cobro de la factura remitida al Usuario y no abonada por éste. <span class="dividae">Dividae</span> se reserva el derecho de
            anular la cuenta y prohibir la reclamación de otras deudas a aquellos usuarios que incumplan lo estipulado en estos Términos y Condiciones.
        </p>
